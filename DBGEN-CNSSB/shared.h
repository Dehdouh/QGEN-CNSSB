...
#define  DATE_LEN_EXT  18  /* extended date for nosql*/
...
/*why only 10? in dists.dss, there is an entry with 4-NOT SPECIFIED, which is sup to 10 (length is 15)
 * But buffer overflow didn't appeared on windows previously... Corection is to increase these value
 */
